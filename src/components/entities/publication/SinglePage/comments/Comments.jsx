...
const Comments = ({ currentUserId }) => { /* currentUserId proviene desde el padre */
    const { publiComments, getCommentsByPubliId } = useContext(CommentContext);
    ...
    // */
    useEffect(() => {
        getCommentsByPubliId("62b80e95724950464484fafe");

    }, []);

    useEffect(() => {
        console.log(publiComments)
    ...
    return (
        <div className='comments'>
            ...
            <div className="comments-container">
                {publiComments.map((comment, index) => (  /* Con esto hago un .map para traer a los comentarios padres que indique en rootComments */
